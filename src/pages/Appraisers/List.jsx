...
const List = () => {
  ...
  const [data, setData] = useState([
    ...
    },
    {
      ...
      type: "Organization",
      experience: "2000",
      establishedSince: "2000",
      address: "456 Lakewood, USA",
    ...
    },
    {
      ...
      experience: "5 years",
      establishedSince: "-",
      address: "890 Pine Avenue, USA",
      phone: "+1 (777) 888-9999",
      email: "experts@email.com",
      status: "Active",
    },
  ]);
  ...
  const handleSaveNewAppraiser = () => {
    const newId = data.length > 0 ? data[data.length - 1].id + 1 : 1;
    const appraiserToAdd = { ...newAppraiser, id: newId };
    setData([...data, appraiserToAdd]);
