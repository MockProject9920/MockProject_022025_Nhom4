      ...
      >
        <div className="p-6 w-[470px] h-[515px] border-gray-300 border-2 m-[120px] shadow-lg rounded-lg bg-white relative">
          ...
          <div className="relative top-4 left-4">
            <div className="absolute -left-24 top-[190px] w-0 h-0 border-b-[20px] border-b-transparent  border-l-[20px] border-l-[#7A70F1]"></div>
            <div className="relative top-[172px] -left-[24px] w-[115px] h-7 flex items-center justify-center bg-[#7A70F1] text-white rounded-[5px]">
              <p className="text-sm font-semibold">
                <i className="ri-sparkling-fill mr-1"></i> POPULAR
              </p>
            </div>
