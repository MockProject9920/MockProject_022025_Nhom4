...
//         <div className="absolute -left-3 top-0 w-0 h-0 border-t-[20px] border-t-transparent border-b-[20px] border-b-transparent border-r-[20px] border-r-[#7A70F1]"></div>

//         {/* Nhãn POPULAR */}
//         <div className="relative w-[115px] h-7 flex items-center justify-center bg-[#7A70F1] text-white rounded-[4px]">
...
//        "
//       >
//         <div className="shadow-gray-500 border-b-2 border-[#E0DEF7]">
//           <p className=" text-[#100A55] font-bold text-2xl my-8 ml-18 ">
//             <i class="ri-home-3-fill text-[#7A70F1]"></i> Estatery
//           </p>
//         </div>

//         <div className="mt-20 ml-36 w-[352px]">
...
//               <p>
//                 {" "}
//                 <i class="ri-hotel-bed-line text-[#7A70F1]"></i> 4Beds
//               </p>
//               <p>
//                 <i class="ri-contrast-drop-2-fill text-[#7A70F1]"></i>{" "}
//                 2Bathrooms
//               </p>
//               <p>
//                 <i class="ri-square-line text-[#7A70F1]"></i> 6x7.5m<sup>2</sup>
//               </p>
//             </div>

//             <div className="flex justify-between items-center h-[100px] mt-4 p-4 border-2 border-[#E0DEF7] bg-[#F7F7FD] rounded-lg">
//               <div>
  ...
  return (
    <div className="flex flex-row w-screen h-screen bg-white">
      <div className="basis-1/2 bg-white">
        <div className="shadow-gray-500 border-b-2 border-[#E0DEF7]">
          <p className="text-[#100A55] font-bold text-2xl my-8 ml-18">
            <i className="ri-home-3-fill text-[#7A70F1]"></i> Estatery
          </p>
        </div>

        <div className="mt-20 ml-36 w-[352px]">
          <p className="text-4xl font-bold mb-3">Welcome back</p>
          <p className="text-lg text-[#90959F] mb-7">
      ...
      <div
        ...
        style={{ backgroundImage: `url(${BackgroundLogin})` }}
      >
        <div className="px-6 pb-6 w-[470px] h-[515px] border-gray-300 border-2 m-[120px] shadow-lg rounded-lg bg-white relative">
          {/* Popular Badge */}
          <div className="relative top-4 left-4">
            <div className="absolute -left-[50px] top-[233px] w-0 h-0 border-b-[10px] border-b-transparent  border-r-[10px] border-r-[#7A70F1]"></div>
            <div className="relative top-[208px] -left-[50px] w-[115px] h-7 flex items-center justify-center bg-[#7A70F1] text-white rounded-[5px]">
              <p className="text-sm font-semibold">
                <i className="ri-sparkling-fill mr-1"></i> POPULAR
              </p>
            </div>
          ...
          <div>
            ...
            <div className="flex space-x-3 text-[#6e727b]">
              <p>
                <i className="ri-hotel-bed-line text-[#7A70F1]"></i> 4 Beds
              </p>
              <p>
                <i className="ri-contrast-drop-2-fill text-[#7A70F1]"></i> 2
                Bathrooms
              </p>
              <p>
                <i className="ri-square-line text-[#7A70F1]"></i> 6x7.5m
                <sup>2</sup>
              </p>
            </div>
