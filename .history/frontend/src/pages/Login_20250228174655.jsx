    ...
    <div className=" flex flex-row w-screen h-screen bg-white">
      ...
      >
        <div className="p-6 w-[470px] h-[515px] border-gray-300 border-2 m-[120px]  shadow-lg rounded-lg bg-white ">
          ...
          />
          <div>
            <div className="flex justify-between my-6 pb-4 border-b-2 border-gray-300">
              <div>
                <p className="text-2xl font-bold">Beverly Springfield</p>
                <p className="text-[#90959F] ">2821 Sevilla, Palm Harbor, TX</p>
              </div>
              <div className="w-12 h-12 flex items-center justify-center rounded-full border-2 border-[#F7F6FD]">
            ...
            <div className="flex justify-between mt-4 p-3 border-2 border-[#E0DEF7]">
              <div>
                <p>Rent sale</p>
                <p>$2700/month</p>
              </div>
