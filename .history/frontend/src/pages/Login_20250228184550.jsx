  ...
  return (
    <div className="flex flex-row w-screen h-screen bg-white">
      ...
      <div
        ...
        style={{ backgroundImage: `url(${BackgroundLogin})` }}
      >
        <div className="p-6 w-[470px] h-[515px] border-gray-300 border-2 m-[120px] shadow-lg rounded-lg bg-white relative">
          {/* Popular Badge */}
          <div className="relative top-4 left-4">
            <div className="absolute -left-[24px] top-[197px] w-0 h-0 border-b-[10px] border-b-transparent  border-r-[10px] border-r-[#7A70F1]"></div>
            <div className="relative top-[172px] -left-[22px] w-[115px] h-7 flex items-center justify-center bg-[#7A70F1] text-white rounded-[5px]">
              <p className="text-sm font-semibold">
                <i className="ri-sparkling-fill mr-1"></i> POPULAR
              </p>
            </div>
