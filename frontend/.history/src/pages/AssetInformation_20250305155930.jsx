...
function AssetInformation() {
  return (
    <div className="flex space-x-0 py-10 h-screen w-screen">
      ...
      <div className="flex w-full space-x-4 justify-end mr-60px">
        {/* Ô tìm kiếm có icon bên trong */}
        <div className="relative">
          <input
            placeholder="Search"
            className="w-[250px] h-10 border border-[#2772BD] text-left py-2 pr-10 pl-4 rounded-xl"
          />
          <i className="ri-search-line absolute right-3  transform -translate-y-1/2 text-[#2772BD] text-xl"></i>
        </div>
