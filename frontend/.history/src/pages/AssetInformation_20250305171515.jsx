      ...
      <div className="w-full p-6 ">
        ...
        <div className="mt-8 space-y-6 ml-20">
          ...
          <div className="flex flex-col md:flex-row md:items-center md:space-x-4">
            ...
            <select className="h-10 p-1 ml-63 rounded-xl bg-[#D4A373] w-full md:w-auto">
          ...
          <div className="flex flex-col md:flex-row md:items-center md:justify-between ">
            ...
            <input className="border p-2 w-full mr-30 md:w-150 h-10" />
          </div>
          <div className="flex flex-col md:flex-row md:items-center md:justify-between">
            <p className="font-medium">Area (m²):</p>
            <input className="border p-2 mr-30 w-full md:w-150 h-10" />
          </div>
          <div className="flex flex-col md:flex-row md:items-center md:space-x-4">
            <p className="font-medium">Construction Materials:</p>
            <select className="h-10 p-1 ml-50 rounded-xl bg-[#D4A373] w-full md:w-40 md:ml-0">
          ...
          <div className="flex flex-col md:flex-row md:items-center md:justify-between">
            ...
            <input
              placeholder="USD"
              className="border p-2 mr-30 text-right w-full md:w-150 h-10"
            />
          </div>
        </div>
