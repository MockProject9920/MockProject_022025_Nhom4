    ...
    <div className="flex space-x-0 py-10 h-screen">
      ...
      <div>
        <div className="relative w-full">
          <input
            placeholder="Search"
            className="w-full h-10 border border-[#2772BD] text-center py-2 px-10 rounded-xl"
          />
          <i className="ri-search-line absolute left-3 top-1/2 transform -translate-y-1/2 text-[#2772BD] text-xl"></i>
        </div>
      </div>
    </div>
  );
