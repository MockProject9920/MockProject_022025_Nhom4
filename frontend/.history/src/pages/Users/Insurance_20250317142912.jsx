...
//   return (
//     <div>
//       <div className="flex space-x-8 justify-center p-4 text-xl border border-b-2 border-blue-700">
//         <div>
...
function Insurance() {
  ...
  return (
    <div>
      <div className="flex space-x-8 justify-center text-xl border-b-2 border-blue-700 bg-white w-full py-2">
        <div>
          <p>Asset Information</p>
        </div>
        <div>
