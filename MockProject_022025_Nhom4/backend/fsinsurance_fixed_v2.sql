...
CREATE TABLE `claim_requests` (
  ...
  CONSTRAINT `claim_requests_ibfk_1` FOREIGN KEY (`user_id`) REFERENCES `users` (`id`) ON DELETE SET NULL,
  CONSTRAINT `claim_requests_ibfk_2` FOREIGN KEY (`policy_contract_id`) REFERENCES `policy_contracts` (`id`) ON DELETE CASCADE,
  CONSTRAINT `claim_requests_ibfk_3` FOREIGN KEY (`client_id`) REFERENCES `clients` (`client_id`) ON DELETE SET NULL
) ENGINE=InnoDB AUTO_INCREMENT=21 DEFAULT CHARSET=utf8mb4 COLLATE=utf8mb4_general_ci;
/*!40101 SET character_set_client = @saved_cs_client */;
...
INSERT INTO `claim_requests` VALUES (1,2001,1,1001),(2,2002,2,1002),(3,2003,3,1003),(4,2004,4,1004),(5,2005,5,1005),(6,2006,6,1006),(7,2007,7,1007),(8,2008,8,1008),(9,2009,9,1009),(10,2010,10,1010),(11,2011,1,1011),(12,2012,2,1012),(13,2013,3,1013),(14,2014,4,1014),(15,2015,5,1015),(16,2016,6,1016),(17,2017,7,1017),(18,2018,8,1018),(19,2019,9,1019),(20,2020,10,1020);
...
INSERT INTO `claims` VALUES (1,1,'Property','Property damage','0000-00-00','0000-00-00','0000-00-00','Fire damaged kitchen',25000.00,'Requested','Fire_Report_1.pdf',NULL,NULL,'Awaiting fire department report',2001),(2,1,'Property','Property damage','0000-00-00','0000-00-00','0000-00-00','Fire damaged kitchen',25000.00,'Approved','Fire_Report_1.pdf',22000.00,'0000-00-00','Damage assessment completed',2001),(3,2,'Liability','Personal accidents','0000-00-00','0000-00-00','0000-00-00','Guest slipped on wet floor',50000.00,'In Review','Slip_Incident_3.pdf',NULL,NULL,'Reviewing CCTV footage',2002),(4,3,'Property','Property damage','0000-00-00','0000-00-00','0000-00-00','Water leak damaged basement',15000.00,'Approved','Leak_Report_4.pdf',12000.00,'0000-00-00','Contractor estimate completed',2003),(5,4,'Liability','Environmental damage','0000-00-00','0000-00-00','0000-00-00','Neighbor claims tree damage',5000.00,'Requested','Tree_Damage_5.pdf',NULL,NULL,'Assessing property lines',2004),(6,5,'Property','Property damage','0000-00-00','0000-00-00','0000-00-00','Storm shattered windows',8000.00,'Approved','Storm_Report_6.pdf',7000.00,'0000-00-00','Wind speed reports confirmed',2005),(7,6,'Property','Property damage','0000-00-00','0000-00-00','0000-00-00','Burst pipe flooded living room',30000.00,'In Review','Flood_7.pdf',NULL,NULL,'Plumbing inspection ongoing',2006),(8,7,'Liability','Personal accidents','0000-00-00','0000-00-00','0000-00-00','Delivery person tripped',20000.00,'Approved','Trip_Incident_8.pdf',18500.00,'0000-00-00','Eyewitness statements collected',2007),(9,8,'Property','Property damage','0000-00-00','0000-00-00','0000-00-00','Car crashed into garage',40000.00,'Approved','Crash_Report_9.pdf',38000.00,'0000-00-00','Police report verified',2008),(10,9,'Property','Property damage','0000-00-00','0000-00-00','0000-00-00','Vandalism damaged fence',6000.00,'In Review','Vandalism_10.pdf',NULL,NULL,'Reviewing security footage',2009),(11,10,'Liability','Personal accidents','0000-00-00','0000-00-00','0000-00-00','Tenant injured on stairs',45000.00,'Requested','Injury_Report_11.pdf',NULL,NULL,'Evaluating medical records',2010),(12,11,'Property','Property damage','0000-00-00','0000-00-00','0000-00-00','Wildfire damage',150000.00,'Approved','Wildfire_12.pdf',140000.00,'0000-00-00','Fire damage assessment completed',2011),(13,12,'Property','Property damage','0000-00-00','0000-00-00','0000-00-00','Hailstorm damaged roof',35000.00,'In Review','Hailstorm_13.pdf',NULL,NULL,'Roofing contractor evaluating',2012),(14,13,'Liability','Environmental damage','0000-00-00','0000-00-00','0000-00-00','Oil leak on driveway',3500.00,'Approved','Oil_Leak_14.pdf',3000.00,'0000-00-00','Cleanup team confirmed',2013),(15,14,'Property','Property damage','0000-00-00','0000-00-00','0000-00-00','Earthquake foundation cracks',60000.00,'In Review','Earthquake_15.pdf',NULL,NULL,'Structural engineer assessing',2014),(16,15,'Property','Property damage','0000-00-00','0000-00-00','0000-00-00','Flooded basement',20000.00,'Approved','Flood_16.pdf',18000.00,'0000-00-00','FEMA assistance reviewed',2015),(17,16,'Liability','Personal accidents','0000-00-00','0000-00-00','0000-00-00','Contractor fell off ladder',75000.00,'Requested','Ladder_17.pdf',NULL,NULL,'OSHA safety compliance checked',2016),(18,17,'Property','Property damage','0000-00-00','0000-00-00','0000-00-00','Electrical fire in garage',55000.00,'Approved','Fire_Garage_18.pdf',52000.00,'0000-00-00','Electrical inspection confirmed',2017),(19,18,'Liability','Environmental damage','0000-00-00','0000-00-00','0000-00-00','Water contamination claim',10000.00,'In Review','Water_Contam_19.pdf',NULL,NULL,'EPA investigation ongoing',2018),(20,19,'Property','Property damage','0000-00-00','0000-00-00','0000-00-00','Tree fell on roof',28000.00,'Approved','Tree_Roof_20.pdf',25500.00,'0000-00-00','Arborist report reviewed',2019),(99999,19,'Property','','0000-00-00','0000-00-00','0000-00-00','',0.00,'',NULL,NULL,NULL,NULL,NULL);
...
INSERT INTO `invoices` VALUES (5001,1001,500.00,'Paid'),(5002,1002,700.00,'Paid'),(5003,1003,1200.00,'Pending'),(5004,1004,2000.00,'Paid'),(5005,1005,5000.00,'Pending'),(5006,1006,850.00,'Paid'),(5007,1007,1500.00,'Paid'),(5008,1008,600.00,'Overdue'),(5009,1009,3200.00,'Paid'),(5010,1010,900.00,'Paid'),(5011,1011,750.00,'Pending'),(5012,1012,2500.00,'Paid'),(5013,1013,1100.00,'Overdue'),(5014,1014,950.00,'Paid'),(5015,1015,4000.00,'Pending'),(5016,1016,650.00,'Paid'),(5017,1017,3750.00,'Paid'),(5018,1018,5500.00,'Overdue'),(5019,1019,1800.00,'Pending'),(5020,1020,2200.00,'Paid');
...
CREATE TABLE `policy_contracts` (
  ...
  KEY `policy_contracts_ibfk_1` (`client_id`),
  CONSTRAINT `policy_contracts_ibfk_1` FOREIGN KEY (`client_id`) REFERENCES `clients` (`client_id`) ON DELETE CASCADE,
...
-- Dump completed on 2025-03-14 12:00:51
