      ...
      <div className="mt-4 flex justify-between">
        ...
        <div className="flex space-x-3">
          <button
            ...
            className="px-4 py-2 bg-amber-900 h-10 text-white rounded-md shadow-md hover:bg-[#8a94b8] disabled:bg-gray-300 disabled:cursor-not-allowed"
          >
            Previous
          </button>
          <button
            ...
            className="px-4 py-2 bg-[#a9b1ca] h-10 text-white rounded-md shadow-md hover:bg-[#8a94b8] disabled:bg-gray-300 disabled:cursor-not-allowed"
          >
            Next
          </button>
        </div>
