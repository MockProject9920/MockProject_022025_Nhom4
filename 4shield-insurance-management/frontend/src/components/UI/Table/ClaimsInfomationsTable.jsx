...
const ClaimsInformation = () => {
    ...
    const validateField = (fieldName, value) => {
        switch (fieldName) {
            ...
            case 'evidence':
                return value && value.size > 5 * 1024 * 1024 ? 'File size must be under 5MB' : '';
            default:
                return '';
        }
    };
    ...
    return (
        <div className="container mx-auto p-6 bg-gray-50 min-h-screen">
            <nav className="flex space-x-8 border-b mb-6">
                <Link to="/claims-insurance-contract" className="text-gray-600">Insurance Contract</Link>
                <a className="text-black font-medium border-b-2 border-black pb-2">Claim Information</a>
                <a href="#" className="text-gray-600">List of claims</a>
            </nav>

            <h1 className="text-3xl font-bold text-gray-800 mb-4">Submit Insurance Claim</h1>
            <p className="mb-4 text-gray-600">Enter damage information to submit a claim quickly</p>
            ...
            <form onSubmit={handleSubmit} className="space-y-6">
                ...
                <div className="mb-4">
                    <label className="block text-gray-600 mb-2">Image/Video evidence:</label>
                    <input
                        type="file"
                        className="w-full p-2 border rounded-md"
                        name="evidence"
                    ...
                    {formData.evidence && <p className="text-gray-600">Uploaded: {formData.evidence.name}</p>}
                </div>
                ...
                <div className="flex items-center">
                    <input
                        ...
                        className="mr-2"
                    />
                    <span className="text-gray-600">I certify that the above information is correct</span>
                </div>
