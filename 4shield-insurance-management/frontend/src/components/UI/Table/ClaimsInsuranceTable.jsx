        ...
        <div className="p-6">
            ...
            <div className="bg-white shadow-lg rounded-lg p-6 overflow-x-auto">
                ...
                <div className="hidden md:block lg:hidden">
                    {claimsSettlement.map((claim) => (
                        <div key={claim.id} className="bg-gray-50 mb-4 p-4 rounded-lg shadow-md">
...
//         <a href="#" className="text-black font-medium border-b-2 border-black pb-2">Insurance Contract</a>
//         <Link to="/user/claims/information" className="text-gray-600">Claim Information</Link>
//         <a href="#" className="text-gray-600">List of claims</a>
//       </nav>
//       <h1 className="text-3xl font-bold my-6">Submit Insurance Claim</h1>
//       <p className="mb-4 text-gray-700">Enter damage information to submit a claim quickly</p>

//       <div className="mb-6">
//         <label className="block text-gray-700 mb-2">Select Insurance Contract</label>
//         <select className="w-full p-2 border rounded-md" value={selectedContract} onChange={handleChange}>
...
//         <p className="text-lg mb-4">Insurance type: <span className='text-gray-700 text-base'>{type}</span></p>
//         <p className="text-lg mb-4">Effective date - Expiry date: <span className='text-gray-700 text-base'>{dates}</span></p>
//         <p className="text-lg ">Property address: <span className='text-gray-700 text-base'>{address}</span></p>
//       </div>
//     </div>
//   );
// };
