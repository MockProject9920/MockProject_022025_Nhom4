                    ...
                    <tbody>
                        {claimsSettlement.map((claim) => (
                            <tr key={claim.id} className="border-b hover:bg-gray-100">
                                ...
                                <td className="p-4">
                                    <span className={`px-4 py-1 rounded-full text-white w-[100px] block ${claim.status === "In Review" ? "bg-green-500" : "bg-blue-500"}`}>
                                        {claim.status}
                                    </span>
                                </td>
                ...
                <div className="hidden md:block lg:hidden">
                    {claimsSettlement.map((claim) => (
                        <div key={claim.id} className="bg-gray-50 mb-4 p-4 rounded-lg shadow-md">
                            ...
                            <p className="sm:py-3">
                                Status: <span className={`px-4 py-1 rounded-full text-white  ${claim.status === "In Review" ? "bg-green-500" : "bg-blue-500"}`}>{claim.status}</span>
                            </p>
                    ...
                    {claimsSettlement.map((claim) => (
                        <div key={claim.id} className="bg-gray-50 mb-4 p-4 rounded-lg shadow-md">
                            ...
                            <p className="sm:py-3 flex flex-col">
                                Status: <span className={`px-4 py-1 rounded-full text-white w-[106px] ${claim.status === "In Review" ? "bg-green-500" : "bg-blue-500"}`}>{claim.status}</span>
                            </p>
                            <p className="">Method: {claim.method}</p>
                            <div className="flex flex-wrap gap-4 mt-4">
                                <button onClick={() => openModal("edit", claim)} className="flex items-center gap-2 bg-yellow-500 text-white px-4 py-2 rounded-lg shadow-md hover:bg-yellow-600 transition ">
